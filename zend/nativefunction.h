...
public:
     ...
     */
    NativeFunction(const char *name, const native_callback_0 &function, const Arguments &arguments = {}, bool return_ref = false) : Callable(name, arguments, return_ref), _type(0) { _function.f0 = function; }
    NativeFunction(const char *name, const native_callback_1 &function, const Arguments &arguments = {}, bool return_ref = false) : Callable(name, arguments, return_ref), _type(1) { _function.f1 = function; }
    NativeFunction(const char *name, const native_callback_2 &function, const Arguments &arguments = {}, bool return_ref = false) : Callable(name, arguments, return_ref), _type(2) { _function.f2 = function; }
    NativeFunction(const char *name, const native_callback_3 &function, const Arguments &arguments = {}, bool return_ref = false) : Callable(name, arguments, return_ref), _type(3) { _function.f3 = function; }
