...
protected:
    ...
    void property(const char *name, short value, int flags = Php::Public);
    void property(const char *name, int value, int flags = Php::Public);
    void property(const char *name, long value, int flags = Php::Public);
    void property(const char *name, long long value, int flags = Php::Public);
